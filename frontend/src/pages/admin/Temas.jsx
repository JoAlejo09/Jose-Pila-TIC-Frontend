...
const Temas = () => {
    ...
    const temasFiltrados = useMemo(() => {
        return temas.filter((tema) => {
            const coincideBusqueda = tema.nombre
                .toLowerCase()
                .includes(
                    buscar.toLowerCase()
                );
            ...
            const coincideUnidad = filtroUnidad === ""
                ||
    ...
    }, [ temas, buscar, filtroMateria, filtroUnidad]);
