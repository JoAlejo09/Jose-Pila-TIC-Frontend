...
const CompletarPerfil = () =>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            console.log(error);
            setError(error.response?.data?.msg || "Error al completar perfil")            
        }
        finally{
            setLoading(false)
        }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
        <div className="gb-white shadow-lg rounded-xl p-8 w-full max-w-2xl">
            <h1 className="text-3xl font-bold mb-2 text-center">
                Completar Perfil
            </h1>
            <p className="text-gray-500 text-center mb6">
            ...
            <form onSubmit={handleSubmit}
                ...
                <div>
                    <label className="block mb-1 font-semibold">Telefono</label>
                    <input type="text"
                            name="telefono"
                            value={form.telefono}
                ...
                {/*DIVISION DE ROLES - INFO PARA ESTUDIANTE */}

                {usuario?.rol === "estudiante" && (
                    <>
                    <div>
                        <label className="block mb-1 font-semibold">Institucion</label>
                        <input type="text"
                                name="institucion"
                    ...
                    <div>
                        <label className="block mb-1 font-semibold">Nivel Academico</label>
                        <select name="nivelAcademico"
                                value={form.nivelAcademico}
                                onChange={handleChange}
                                className="w-full border p-2 rounded">
                            <option value="">Seleccion el año en el que se encuentra</option>
                            <option value="1ro BGU">1° Bachillerato</option>
                            <option value="2do BGU">2° Bachillerato</option>
                            <option value="3ro BGU">3° Bachillerato</option>
                        </select>
                    </div>
                ...
                {/*DIVISION DE ROLES INFO PARA TUTOR */}
                {usuario?.rol === "tutor" && (
                    <>
                    <div>
                    ...
                    <div>
                        <label className="block mb-1 font-semibold"> Experiencia </label>
                        <input type="text"
                                name="experiencia"
                    ...
                    <div>
                        <label className="block mb-1 font-semibold"> Titulación </label>
                        <input type="text"
                                name="titulacion"
