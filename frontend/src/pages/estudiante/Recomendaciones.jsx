...
import { obtenerMisRecomendacionesRequest } from "../../services/recomendacionService.js";
        ...
        <div className="min-h-screen bg-gray-50 p-6">
            ...
            <div className=" grid md:grid-cols-4 gap-5 mb-8">
                ...
                <div
                    ...
                    className="bg-red-100 rounded-2xl p-6 cursor-pointer
                                        ...
                                        >
                                            ...
                                            <button onClick={()=>
                                                ...
                                                className="mt-4 w-full bg-blue-600
                                                         text-white py-2 rounded-xl hover:bg-blue-700
                                                "
                                            >
                                                Abrir recurso
                                            </button>
